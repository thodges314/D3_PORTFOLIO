...
import { stateNamesToCodes } from './stateMapping';
...
export const USStateMap = ({ data, chart_title, chart_subtitle }) => {
  ...
  useEffect(() => {
    ...
    usData.features.forEach((d) => {
      const match = data.find(
        (e) => e['dpa_main.value'] === stateNamesToCodes[d.properties.NAME]
      );
    ...
    mapDropShadowG
      .selectAll('.state-shadow')
      .data(usData.features)
      .enter()
      .append('path')
      .attr('class', 'state-shadow')
